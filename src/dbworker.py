...
class Users:
    __path__ = "/home/h0llu/Everything/University/2 course/4 semester/TRPP/Project/src/Databases/Users.db"
    def __init__(self):
...
class Schedule_last_request:
    __path__ = "/home/h0llu/Everything/University/2 course/4 semester/TRPP/Project/src/Databases/Schedule.db"
    def __init__(self):
        con = sqlite3.connect(self.__path__)
        cursor = con.cursor()
...
class Subs:
    __path__ = "/home/h0llu/Everything/University/2 course/4 semester/TRPP/Project/src/Databases/Subs.db"
    def __init__(self):
        con = sqlite3.connect(self.__path__)
        cursor = con.cursor()
...
class Professors:
    __path__ = "/home/h0llu/Everything/University/2 course/4 semester/TRPP/Project/src/Databases/Professors.db"
    def __init__(self):
        con = sqlite3.connect(self.__path__)
        cursor = con.cursor()
...
class Victoria:
    __path__ = "/home/h0llu/Everything/University/2 course/4 semester/TRPP/Project/src/Databases/Victoria.db"
    def __init__(self):
        con = sqlite3.connect(self.__path__)
        cursor = con.cursor()
